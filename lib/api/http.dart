...
import 'package:surgetv/model/error_message_model.dart';
...
const String BASE_URL = "http://8.141.13.174/api/v1";

/// woo 电商 api 请求工具类
class Axios {
  static final Axios _instance = Axios._internal();
  factory Axios() => _instance;
